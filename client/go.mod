...
require github.com/freemed/remitt-server/model v0.0.0-20250404194731-e10125728bd5
...
require (
	...
	github.com/freemed/remitt-server/common v0.0.0-20250404194731-e10125728bd5 // indirect
