...
require (
	...
	github.com/freemed/remitt-server/translation v0.0.0-20250404194731-e10125728bd5
	github.com/freemed/remitt-server/transport v0.0.0-20250404194731-e10125728bd5
)
